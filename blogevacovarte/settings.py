"""
Django settings for blogevacovarte project.
...
ALLOWED_HOSTS = ['codigorosa.pythonanywhere.com','127.0.0.1']
...
ROOT_URLCONF = 'blogevacovarte.urls'
...
WSGI_APPLICATION = 'blogevacovarte.wsgi.application'
